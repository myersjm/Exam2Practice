...
def run_test_practice_problem2a():
    ...
    # Test 1:
    expected = [4, 6, 8, 10, 11]
    actual = practice_problem2a([2, 4, 6, 8, 9], 2)
    print("Test 1------------------------------------------")
    ...
    actual = practice_problem2a([0, 1, 2, 3, 4, 5], 3)
    print("Test 2------------------------------------------")
    print("Expected: ", expected)
    print("Actual: ", actual)
    ...
    # Test 3:
    expected = [-1, 0, 4, 1, -21]
    actual = practice_problem2a([0, 1, 5, 2, -20], -1)
    print("Test 3------------------------------------------")
    print("Expected: ", expected)
    print("Actual: ", actual)
    ...
    # Test 4:
    expected = [5, 0]
    actual = practice_problem2a([0, -5], 5)
    print("Test 4------------------------------------------")
    print("Expected: ", expected)
    print("Actual: ", actual)
...
def practice_problem2b(sequence):
    ...
    for k in range(len(sequence)):
        string = sequence[k]
        if sequence[k] != '':
            firstLetters = firstLetters + string[0]
    return firstLetters
